...
exports.run = async(client, message, args) => {    
 if(!message.member.roles.some(r => ["766681489994678282" , "760404934628868118"].includes(r.id))) // ROL (KAYITÇI, VEYA Bİ ROL İDSİ) İDLERİ ÇOĞALTA BİLİRSİNİZ.
...
if(!adam) {
 ...
 .setThumbnail(message.author.avatarURL)     
    ...
    .setFooter(`Drakula Kayıt Kontrol`)
    .setColor("0x2f3136")
